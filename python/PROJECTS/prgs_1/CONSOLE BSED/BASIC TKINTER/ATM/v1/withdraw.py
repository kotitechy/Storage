...
class withdraw:
    ...
    def depo(self):
        ...
        if self.am1 == self.am2:
            ...
            try:
                with mysql.connector.connect(host=host, user=user, password=password,
    ...
    def srh(self, a, b):
        ...
        try:
            with mysql.connector.connect(host=host, user=user, password=password, database=database_name) as connection:
                cursor = connection.cursor()
