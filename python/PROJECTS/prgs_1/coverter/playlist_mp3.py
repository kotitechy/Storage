...
class playlist_mp3:
    ...
    def extract_audio(self, playlist_url):
        ...
        # Create a subfolder within Downloads for YouTube audio extraction
        output_path = os.path.join(downloads_path, subfolder_name)

        # Create the subfolder if it doesn't exist
        os.makedirs(output_path, exist_ok=True)

        print("Extracting Playlist Audio")
        ...
        for video_url in playlist.video_urls:
            ...
            try:
                ...
                # Download the audio to the specified subfolder
                audio_stream.download(output_path=output_path)
                print(f"Audio from video '{yt.title}' extracted successfully to the '{subfolder_name}' folder in Downloads.")
    ...
    def win(self):
        ...
        root.title("YouTube Audio Extractor")
        ...
        header_label = tk.Label(root, text="Youtube to mp3 playlist", font=('Arial', 20))
        ...
        button = tk.Button(root, text="Start Download mp4 Playlist", command=self.store_url)
