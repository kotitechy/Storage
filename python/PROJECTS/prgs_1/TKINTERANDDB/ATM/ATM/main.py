...
class SwiterzBankApp:
    def __init__(self, master):
        ...
        image1 = Image.open(r"C:\Users\ksc11\OneDrive\Desktop\ATM\wel.gif")
        self.gif1 = ImageTk.PhotoImage(image1)

        image2 = Image.open(r"C:\Users\ksc11\OneDrive\Desktop\ATM\wel.gif")
    ...
    def after_welcome(self):
        ...
        # Button 2
        b2 = tk.Button(self.master, text='TRANSACTIONS', font=('Arial', 12), bg='light blue', width=20, height=2)
        b2.place(x=50, y=170)
